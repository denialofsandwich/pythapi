...
def e_delete_role(role_name):
    ...
    if auth_globals.write_through_cache_enabled:
        for user in auth_globals.users_dict:
            try:
                auth_globals.users_dict[user]["ruleset"]["inherit"].remove(role_name)
            except:
                pass
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "List roles", "DE": "Rollen auflisten"},
        "f_description": {
...
def list_roles(reqHandler, p, args, body):
    ...
    if args["verbose"]:
        return {"data": e_list_roles()}

    else:
        return {"data": list(auth_globals.roles_dict.keys())}
        ...
        "params": [
            {
                ...
                "f_name": {"EN": "Role name", "DE": "Rollenname"},
            }
        ],
        "f_name": {"EN": "Get role", "DE": "Zeige Rolle"},
        "f_description": {
    ...
    plugin,
    {
        ...
        "body": {
            "inherit": {
                "type": list,
                "default": [],
                "f_name": {"EN": "Parent groups", "DE": "Übergeordnete Gruppen"},
                "childs": {"type": str},
            },
            "permissions": {
                "type": list,
                "default": [],
                "f_name": {"EN": "Permissions", "DE": "Berechtigungen"},
                "childs": {"type": str},
            },
        },
        "f_name": {"EN": "Create role", "DE": "Rolle erstellen"},
        "f_description": {
...
def create_role(reqHandler, p, args, body):
    ...
    return {"id": str(e_create_role(p[0], body))}
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "Edit role", "DE": "Rolle editieren"},
        "f_description": {
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "Delete role", "DE": "Rolle löschen"},
        "f_description": {"EN": "Deletes a role.", "DE": "Löscht eine Rolle."},
    },
)
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "Add role to user", "DE": "Füge Benutzer eine Rolle hinzu"},
        "f_description": {
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "Remove role from user", "DE": "Entferne Rolle von Benutzer"},
        "f_description": {
