...
def e_get_current_user_info():
    ...
    if auth_globals.auth_type == "token":
        ...
        if (
            not "inherit" in token_data["ruleset"]
            or not "*" in token_data["ruleset"]["inherit"]
        ):
...
def e_get_db_user_by_id(user_id):
    ...
    with db:
        ...
        try:
            ...
            api_log().error(
                "e_get_db_user_by_id: {}".format(api_tr("GENERAL_SQL_ERROR"))
            )
            raise WebRequestException(501, "error", "GENERAL_SQL_ERROR")
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "Get current user", "DE": "Zeige momentaten Benutzer"},
        "f_description": {
...
def get_current_user(reqHandler, p, args, body):
    return {"data": e_get_current_user_info()}
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "List users", "DE": "Benutzer auflisten"},
        "f_description": {
...
def list_users(reqHandler, p, args, body):
    ...
    if args["verbose"]:
        return {"data": e_list_users()}

    else:
        return {"data": list(auth_globals.users_dict.keys())}
...
@api_action(
    plugin,
    {
        ...
        "body": {
            "password": {"type": str, "f_name": {"EN": "Password", "DE": "Passwort"}}
        },
        "f_name": {"EN": "Change password", "DE": "Passwort ändern"},
        "f_description": {
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "Get user", "DE": "Zeige Benutzer"},
        "f_description": {
...
@api_action(
    plugin,
    {
        ...
        "body": {
            ...
            "ruleset": {
                "type": dict,
                "f_name": {"EN": "Ruleset", "DE": "Regelsatz"},
                "default": {},
            },
        },
        "f_name": {"EN": "Create user", "DE": "Benutzer erstellen"},
        "f_description": {
...
def create_user(reqHandler, p, args, body):
    ...
    return {"id": str(e_create_user(p[0], "default", body))}
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "Edit user", "DE": "Benutzer editieren"},
        "f_description": {
...
@api_action(
    plugin,
    {
        ...
        "f_name": {"EN": "Delete user", "DE": "Benutzer löschen"},
        "f_description": {"EN": "Deletes a user.", "DE": "Löscht einen Benutzer."},
    },
)
